...
JP = datetime.timezone(datetime.timedelta(hours=+9), name='JP')
cv2.imwrite("short"+str(datetime.datetime.now(JP))+".jpg",short)
cv2.imwrite("normal"+str(datetime.datetime.now(JP))+".jpg", normal)
cv2.imwrite("long1"+str(datetime.datetime.now(JP))+".jpg",long)
cv2.imwrite("merged"+str(datetime.datetime.now(JP))+".jpg", merged)
